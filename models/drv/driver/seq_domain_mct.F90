...
!----------------------------- zhh debug ------------------------
    print*, 'atmsize = ', atmsize
    print*, 'gatmsize = ', gatmsize
!----------------------------- zhh debug ------------------------
!
    if (lnd_present) then
...
!----------------------------- zhh debug ------------------------
       print*, 'lndsize = ', lndsize
       print*, 'glndsize = ', glndsize
!----------------------------- zhh debug ------------------------
...
!----------------------------- zhh debug ------------------------
       print*, 'ocnsize = ', ocnsize
       print*, 'gocnsize = ', gocnsize
!----------------------------- zhh debug ------------------------
...
!----------------------------- zhh debug ------------------------
       print*, 'icesize = ', icesize
       print*, 'gicesize = ', gicesize
!----------------------------- zhh debug ------------------------
