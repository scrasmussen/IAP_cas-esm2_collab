...
!       x2o_o%rAttr(index_x2o_Forr_ioff ,n) = x2o_o%rAttr(index_x2o_Forr_ioff ,n) * flux_epbalfact
       ...
       ! juanxiong he
       !---------------------------------------------------------------------------
       if ( (index_x2o_Sa_co2prog /=0) .and. (index_a2x_Sa_co2diag /=0)) then
          x2o_o%rAttr(index_x2o_Sa_co2prog,n) = a2x_o%rAttr(index_a2x_Sa_co2diag,n)
       end if
       if ( (index_x2o_Sa_co2diag /=0) .and. (index_a2x_Sa_co2diag /=0)) then
          x2o_o%rAttr(index_x2o_Sa_co2diag,n) = a2x_o%rAttr(index_a2x_Sa_co2diag,n)
       end if
       if ( (index_x2o_Sa_co2prog /=0) .and. (index_a2x_Sa_co2prog /=0)) then
          x2o_o%rAttr(index_x2o_Sa_co2prog,n) = a2x_o%rAttr(index_a2x_Sa_co2prog,n)
       end if
       if ( (index_x2o_Sa_co2diag /=0) .and. (index_a2x_Sa_co2prog /=0)) then
          x2o_o%rAttr(index_x2o_Sa_co2diag,n) = a2x_o%rAttr(index_a2x_Sa_co2prog,n)
       end if
       !---------------------------------------------------------------------------
       ! juanxiong he
       !---------------------------------------------------------------------------
