...
set relpath = ocn/licom/$OCN_GRID
...
if ($command == set_nt) then
   ...
   echo ocn.ecosys.setup.csh : setting nt                                        >> $LICOM_BLDNML
   echo ------------------------------------------------------------------------ >> $LICOM_BLDNML
   ...
   echo ocn.ecosys.setup.csh : setting namelist options                          >> $LICOM_BLDNML
   echo ------------------------------------------------------------------------ >> $LICOM_BLDNML
   ...
   #       ccsm_$runtype is the licom model-level variable
...
EOF
   ...
   echo ocn.ecosys.setup.csh : setting tavg_contents variables                   >> $LICOM_BLDNML
   echo ------------------------------------------------------------------------ >> $LICOM_BLDNML
...
#1  Jint_zooC
 ...
 if ($OCN_PRESTAGE == TRUE) then
   ...
   echo ocn.ecosys.setup.csh : prestaging data files                             >> $LICOM_BLDNML
   echo ------------------------------------------------------------------------ >> $LICOM_BLDNML
   ...
   echo ocn.ecosys.setup.csh : data files are not being prestaged                >> $LICOM_BLDNML
   echo ------------------------------------------------------------------------ >> $LICOM_BLDNML
   ...
   echo ocn.ecosys.setup.csh : documenting inputdata files                       >> $LICOM_BLDNML
   echo ------------------------------------------------------------------------ >> $LICOM_BLDNML
  ...
  if (-e $IC_file)    \ls -la $IC_file    >> $licom_document_files
  if (-e $DST_file)   \ls -la $DST_file   >> $licom_document_files
  if (-e $fesed_file) \ls -la $fesed_file >> $licom_document_files
  if (-e $ndep_file)  \ls -la $ndep_file  >> $licom_document_files

else if ($command == ccsm_prestage) then

  #echo ocn.ecosys.setup.csh : writing ccsm prestaging information               >> $LICOM_BLDNML
  #echo ------------------------------------------------------------------------ >> $LICOM_BLDNML
   ...
   echo ocn.ecosys.setup.csh : unrecognized command $command                     >> $LICOM_BLDNML
   echo ------------------------------------------------------------------------ >> $LICOM_BLDNML
