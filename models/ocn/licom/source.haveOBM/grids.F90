...
!lyc 2015.06.23
         DO J = 1,JMT_GLOBAL-1
            DO I = 2,IMT_GLOBAL-1
               VIV_GLOBAL_SURFACE (I,J)= VIT_GLOBAL (I -1,J,1)* VIT_GLOBAL (I -1,J +1,1)* VIT_GLOBAL (I,J&
                   ,1)* VIT_GLOBAL (I,J +1,1)
            END DO
            VIV_GLOBAL_SURFACE (1,J)= VIV_GLOBAL_SURFACE (IMT_GLOBAL,J)
         END DO
         DO I = 1,IMT_GLOBAL
            VIV_GLOBAL_SURFACE (I,JMT_GLOBAL)= 0.0
         END DO
!LPF 20120818
...
!lyc 2014.09.17        deallocate ( vit_global )
!LPF 20120728
!
