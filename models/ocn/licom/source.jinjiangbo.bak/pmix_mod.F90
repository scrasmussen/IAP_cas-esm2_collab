...
!wangty modify 20150917
      real(r8),dimension(:,:,:),allocatable::ricdt,ridt,s2u,s2t
...
!wangty modify 20150917
#if (defined SOLAR)
      REAL(r8),allocatable:: pen(:)
#endif

#if (defined SOLARCHLORO)
      real(r8),dimension(:,:,:),allocatable:: pen_chl   !  be different from pen(kmm1)
#endif
