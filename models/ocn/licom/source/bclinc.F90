...
!$OMP PARALLEL DO PRIVATE (J,I,WKK)
    ...
    DO J = JST,JET
      DO I = 1,IMT
           psur1(I,J,1)=((PSA (I,J)* OD0+ WORK (I,J)* G)/OD0)* VIT (I,J,1)
        DO K = 1,KM
           psur1(I,J,K+1)= psur1(I,J,K)-(GG(I,J,K)/OD0)* DZP (K)* VIT (I,J,K)
         END DO
          DO K = 1,KM
           psur(I,J,K)=0.5* (psur1 (I,J,K) + psur1(I,J,K +1))
          END DO
     END DO
   END DO
#ifdef SPMD
      call exch_boundary(psur,km)
      call exch_boundary(psa,1)
#endif
#endif 
