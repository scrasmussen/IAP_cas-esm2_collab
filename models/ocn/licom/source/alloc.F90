...
!linpf091126
!
      allocate(wsmon(imt,jmt,km),tsmon(imt,jmt,km),uisomon(imt,jmt,km),visomon(imt,jmt,km),wisomon(imt,jmt,km),&
         ssmon(imt,jmt,km),usmon(imt,jmt,km),vsmon(imt,jmt,km))
      allocate(icmon(imt,jmt,2))
      allocate(netmon(imt,jmt,NTRA))
#ifdef omipout
      allocate(ritmon(imt,jmt,km),rictmon(imt,jmt,km))
      allocate(ritsave(imt,jmt,km),rict1(imt,jmt,km))
      allocate(psurmon(imt,jmt,km))
      allocate(psur(imt,jmt,km),psur1(imt,jmt,km+1))
#endif

!
!lhl1204
      allocate(mldmon(imt,jmt))
      allocate(akmmon(imt,jmt,km),aktmon(imt,jmt,km),aksmon(imt,jmt,km),uiso(imt,jmt,km),viso(imt,jmt,km),wiso(imt,jmt,km))
!lhl1204
!lhl20131025
#if ( defined TIDEMIX )
