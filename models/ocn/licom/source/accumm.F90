...
use pconst_mod
use pmix_mod
use forc_mod, only: su,sv,lthf,sshf,lwv,swv,psa,fresh,runoff,mius
      IMPLICIT NONE
...
#ifdef NEWSSBC
            HDMON (I,J)= HDMON (I,J)- mius(I,J)    !outward salt flux JJB20181114
#else
           HDMON (I,J)= HDMON (I,J)+psa(I,J) 
      ...
      DO K = 1,KM
         DO J = 1,JMT
            DO I = 1,IMT
               ...
               UISOMON(I,J,K)=UISOMON(I,J,K)+UISO(I,J,K)
               VISOMON(I,J,K)=VISOMON(I,J,K)+VISO(I,J,K)
               WISOMON(I,J,K)=WISOMON(I,J,K)+WISO(I,J,K) 
#ifdef omipout
               ritmon(I,J,K)=ritmon(I,J,K)+ritsave(I,J,K)
               rictmon(I,J,K)=ritmon(I,J,K)+rict1(I,J,K)
               psurmon (I,J,K)= psurmon (I,J,K) + psur(I,J,K)
#endif
#if (defined SMAG_OUT)
