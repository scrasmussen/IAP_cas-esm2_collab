...
if ($OCN_PRESTAGE == TRUE) then
   ...
   set licom_document   = $2

  if (-e $pcfc_file) \ls -la $pcfc_file    >> $licom_document


else if ($command == ccsm_prestage) then

  #echo ocn.cfc.setup.csh : writing ccsm prestaging information                  >> $LICOM_BLDNML
  #echo ------------------------------------------------------------------------ >> $LICOM_BLDNML
