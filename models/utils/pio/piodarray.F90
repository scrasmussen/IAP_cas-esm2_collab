...
!---------------------------- test zhh ------------------------
    print*, '===================== start: sub. read_darray_3d_real ====================='
!---------------------------- test zhh ------------------------
    call alloc_check(tmpvar,size(array))
    call read_darray_1d_real (File, varDesc, iodesc, tmpvar, iostat)
    array = reshape(tmpvar,shape(array))
...
!---------------------------- test zhh ------------------------
    print*, '===================== start: sub. read_darray_2d_double ====================='
!---------------------------- test zhh ------------------------
    call alloc_check(tmpvar,size(array))
...
!---------------------------- test zhh ------------------------
    print*, '===================== start: sub. read_darray_3d_double ====================='
!---------------------------- test zhh ------------------------
    call alloc_check(tmpvar,size(array))
!---------------------------- test zhh ------------------------
    print*, '------------ sub. read_darray_3d_double: success allocate ----------------'
!---------------------------- test zhh ------------------------
    call read_darray_1d_double (File, varDesc, iodesc, tmpvar, iostat)
!---------------------------- test zhh ------------------------
    print*, '------------ sub. read_darray_3d_double: success call read_darray_1d_double ----------------'
!---------------------------- test zhh ------------------------
    array = reshape(tmpvar,shape(array))
!---------------------------- test zhh ------------------------
    print*, '------------ sub. read_darray_3d_double: success reshape ----------------'
!---------------------------- test zhh ------------------------
    call dealloc_check(tmpvar)
