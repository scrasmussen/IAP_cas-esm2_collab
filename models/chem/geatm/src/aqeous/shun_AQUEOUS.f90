...
! 1:SO4, 2:NH4, 3:NO3, 4:CaCO3, 5:MgCO3, 6:NaCl, 7:Fe(3+), 8:Mn(2+), 9:KCl     
           ...
           CAER(I,J,6) = AMAX1(R_AER(6)* CONVFAC*58.*1.E6, 1.E-20) ! PKCL  UG/M3
...
c
c      data co2 /330./      ! carbon dioxide, ppm
c      data foa /1.e-6/     ! formic acid, ppm
c      data mhp /1.e-6/     ! MHP, ppm
c      data paa /1.e-6/     ! PAA, ppm
c      data nacl /0.05/     ! sea salt, ug/m3
c      data caco3 /0./      ! calcium carbonate, ug/m3
c      data mgco3 /0./      ! magnesium carbonate, ug/m3
c      data a3fe /0.010/    ! Fe+++, ug/m3
c      data b2mn /0.005/    ! Mn++, ug/m3
c      data potcl /0./      ! potassium chloride, ug/m3
