...
!!!!
    ...
    if(lnaqpms_pso4) then
      ...
      gas(i04_83+ixy)=gas(i04_83+ixy)+so4_aqchem(i03+ixy) ! -> SO4--(aq)
      gas(i04_85+ixy)=gas(i04_85+ixy)+no3_aqchem_1d       ! -> NO3- (aq)
      gas(i04_81+ixy)=gas(i04_81+ixy)+nh4_aqchem_1d       ! -> NH4+ (aq)
    endif
    !===================================================================
