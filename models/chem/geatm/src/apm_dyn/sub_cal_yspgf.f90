...
subroutine cal_inorganic_yspgf &
  & ( myid &
...
!      print*,' apm_i&j&k=',i,j,k,yspgf,mdry,mh2o,celrh,celcwc
      yspgf=1.0
    endif

    spgf_3d(i03+ixy) = yspgf
...
end subroutine cal_inorganic_yspgf
