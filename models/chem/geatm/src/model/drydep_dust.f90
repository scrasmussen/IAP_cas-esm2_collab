      subroutine drydep_dust_salt(myid,cflag,month,tsurf,cellat,cellon,height,&
                            press,windu,windv,lrd_lai,wrflai,landuse,tempk,&
...
!c     wind speed
     ...
     &                          (z02(m) - z01(m))
            ...
            stop 'naqpms-ddep-flag erro in drydep_dust.f90'
        endif ! cflag
...
!                    deltaz,wind,z0,pbl,ustar,psih,wstar,lstable)
         ...
         if(trim(cflag).eq.'W89') then
           call vd_dust(z0,deltaz,psih,ustar,diam,rhop,tsurf(i,j),vd)      
