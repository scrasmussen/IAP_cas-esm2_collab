...
#ifdef DUST 
   real(r8), pointer :: lnd_dustemis_bin_1(:)
   real(r8), pointer :: lnd_dustemis_bin_2(:)
   real(r8), pointer :: lnd_dustemis_bin_3(:)
   real(r8), pointer :: lnd_dustemis_bin_4(:)
#endif
...
#ifdef DUST 
      allocate (lnd_dustemis_bin_1  (numgrid))
      allocate (lnd_dustemis_bin_2  (numgrid))
      allocate (lnd_dustemis_bin_3  (numgrid))
      allocate (lnd_dustemis_bin_4  (numgrid))
#endif
...
#ifdef DUST 
         lnd_dustemis_bin_1(g)  = fldv%dustemis_bin_1(g)
         lnd_dustemis_bin_2(g)  = fldv%dustemis_bin_2(g)
         lnd_dustemis_bin_3(g)  = fldv%dustemis_bin_3(g)
         lnd_dustemis_bin_4(g)  = fldv%dustemis_bin_4(g)
#endif
...
#ifdef DUST 
      write(6,*) 'lnd_dustemis_bin_1' , minval(lnd_dustemis_bin_1)    , maxval(lnd_dustemis_bin_1)
      write(6,*) 'lnd_dustemis_bin_2' , minval(lnd_dustemis_bin_2)    , maxval(lnd_dustemis_bin_2)
      write(6,*) 'lnd_dustemis_bin_3' , minval(lnd_dustemis_bin_3)    , maxval(lnd_dustemis_bin_3)
      write(6,*) 'lnd_dustemis_bin_4' , minval(lnd_dustemis_bin_4)    , maxval(lnd_dustemis_bin_4)
#endif
...
! routine:
      ...
      deallocate (lnd_nee  )
#ifdef DUST 
      deallocate (lnd_dustemis_bin_1  )
      deallocate (lnd_dustemis_bin_2  )
      deallocate (lnd_dustemis_bin_3  )
      deallocate (lnd_dustemis_bin_4  )
#endif
