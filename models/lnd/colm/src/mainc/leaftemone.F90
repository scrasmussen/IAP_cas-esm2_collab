...
! input variables
  real(r8), INTENT(in) :: &
        hux,        &! observational height of wind [m]
        htx,        &! observational height of temperature [m]
        hqx,        &! observational height of humidity [m]
...
! assign iteration parameters
   ...
   real(r8) :: &
        hu,         &! corrected height of wind [m]
        ht,         &! corrected height of temperature [m]
        hq,         &! corrected height of humidity [m]
