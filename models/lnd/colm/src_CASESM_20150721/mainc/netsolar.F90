...
!=======================================================================
        ...
        !* if(itypwat<4)then        !non lake and ocean, jidy@17/Aug/2014
           if(itypwat<3)then        !non lake and ocean and permanent ice sheet
           ...
           else if(itypwat==3) then !permanent ice sheet, jidy@17/Aug/2014
              if(coszen>0.) then
                 sabvg = sols *(1.-alb(1,1)) + soll *(1.-alb(2,1)) &
                       + solsd*(1.-alb(1,2)) + solld*(1.-alb(2,2))
                 sabg = sabvg
