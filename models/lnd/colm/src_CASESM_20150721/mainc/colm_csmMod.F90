...
#if (defined COUP_CSM && defined CPL6)
!-----------------------------------------------------------------------
!BOP
!
! !MODULE: colm_csmMod
...
!------------------wangln 2012-06-26 for CAM5---------------------------
  integer :: index_l2c_Sl_fv    ! fv 
  integer :: index_l2c_Sl_ram1    ! ram1
  integer :: index_l2c_Fall_flxdst1    ! dust flux size bin 1
  integer :: index_l2c_Fall_flxdst2    ! dust flux size bin 1
  integer :: index_l2c_Fall_flxdst3    ! dust flux size bin 1
  integer :: index_l2c_Fall_flxdst4    ! dust flux size bin 1
  integer :: index_l2c_Fall_flxvoc1    ! voc flux size bin 1
  integer :: index_l2c_Fall_flxvoc2    ! voc flux size bin 1
  integer :: index_l2c_Fall_flxvoc3    ! voc flux size bin 1
  integer :: index_l2c_Fall_flxvoc4    ! voc flux size bin 1
  integer :: index_l2c_Fall_flxvoc5    ! voc flux size bin 1
!------------------wangln 2012-06-26 for CAM5---------------------------
...
!------------------wangln 2012-06-26 for CAM5---------------------------
  integer :: index_r2c_Forr_ioff      ! ice runoff to ocean
  integer :: index_c2l_Faxa_bcphidry  ! flux: Black Carbon hydrophilic dry deposition
  integer :: index_c2l_Faxa_bcphodry  ! flux: Black Carbon hydropholic dry deposition
  integer :: index_c2l_Faxa_bcphiwet   ! flux: Black Carbon hydrophilic wet deposition
  integer :: index_c2l_Faxa_ocphidry   ! flux: Organic Carbon hydrophilic dry deposition
  integer :: index_c2l_Faxa_ocphodry   ! flux: Organic Carbon hydrophobic dry deposition
  integer :: index_c2l_Faxa_ocphiwet   ! flux: Organic Carbon hydrophilic dry deposition
  integer :: index_c2l_Faxa_dstwet1    ! flux: Size 1 dust -- wet deposition
  integer :: index_c2l_Faxa_dstwet2    ! flux: Size 2 dust -- wet deposition
  integer :: index_c2l_Faxa_dstwet3    ! flux: Size 3 dust -- wet deposition
  integer :: index_c2l_Faxa_dstwet4    ! flux: Size 4 dust -- wet deposition
  integer :: index_c2l_Faxa_dstdry1    ! flux: Size 1 dust -- dry deposition
  integer :: index_c2l_Faxa_dstdry2    ! flux: Size 2 dust -- dry deposition
  integer :: index_c2l_Faxa_dstdry3    ! flux: Size 3 dust -- dry deposition
  integer :: index_c2l_Faxa_dstdry4    ! flux: Size 4 dust -- dry deposition
!------------------wangln 2012-06-26 for CAM5---------------------------
!
! CCSM timers
!
...
!------------------wangln 2012-06-26 for CAM5---------------------------
    write(6,*) ' CoLM Initialize: Nsend, Nrecv & Nroff=', nsend, nrecv, nroff
!------------------wangln 2012-06-26 for CAM5---------------------------
...
!    index_l2c_Sl_v10m    = cpl_interface_contractIndex(contractS,'Sl_v10m')
    index_l2c_Sl_u10m    = cpl_interface_contractIndex(contractS,'Sl_u10')
    index_l2c_Sl_v10m    = cpl_interface_contractIndex(contractS,'Sl_v10')
!------------------wangln 2012-06-26 for CAM5---------------------------
...
!------------------wangln 2012-06-26 for CAM5---------------------------
    index_l2c_Sl_fv         = cpl_interface_contractIndex(contractS,'Sl_fv')
    index_l2c_Sl_ram1       = cpl_interface_contractIndex(contractS,'Sl_ram1')
    index_l2c_Fall_flxdst1  = cpl_interface_contractIndex(contractS,'Fall_flxdst1' )
    index_l2c_Fall_flxdst2  = cpl_interface_contractIndex(contractS,'Fall_flxdst2' )
    index_l2c_Fall_flxdst3  = cpl_interface_contractIndex(contractS,'Fall_flxdst3' )
    index_l2c_Fall_flxdst4  = cpl_interface_contractIndex(contractS,'Fall_flxdst4' )
    index_l2c_Fall_flxvoc1  = cpl_interface_contractIndex(contractS,'Fall_flxvoc1', perrwith='quiet' )
    index_l2c_Fall_flxvoc2  = cpl_interface_contractIndex(contractS,'Fall_flxvoc2', perrwith='quiet' )
    index_l2c_Fall_flxvoc3  = cpl_interface_contractIndex(contractS,'Fall_flxvoc3', perrwith='quiet' )
    index_l2c_Fall_flxvoc4  = cpl_interface_contractIndex(contractS,'Fall_flxvoc4', perrwith='quiet' )
    index_l2c_Fall_flxvoc5  = cpl_interface_contractIndex(contractS,'Fall_flxvoc5', perrwith='quiet' )
!------------------wangln 2012-06-26 for CAM5---------------------------
...
!------------------wangln 2012-06-26 for CAM5---------------------------
  index_c2l_Faxa_bcphidry = cpl_interface_contractIndex(contractR,'Faxa_bcphidry' )
  index_c2l_Faxa_bcphodry = cpl_interface_contractIndex(contractR,'Faxa_bcphodry' )
  index_c2l_Faxa_bcphiwet = cpl_interface_contractIndex(contractR,'Faxa_bcphiwet' )
  index_c2l_Faxa_ocphidry = cpl_interface_contractIndex(contractR,'Faxa_ocphidry' )
  index_c2l_Faxa_ocphodry = cpl_interface_contractIndex(contractR,'Faxa_ocphodry' )
  index_c2l_Faxa_ocphiwet = cpl_interface_contractIndex(contractR,'Faxa_ocphiwet' )
  index_c2l_Faxa_dstwet1  = cpl_interface_contractIndex(contractR,'Faxa_dstwet1' )
  index_c2l_Faxa_dstwet2  = cpl_interface_contractIndex(contractR,'Faxa_dstwet2' )
  index_c2l_Faxa_dstwet3  = cpl_interface_contractIndex(contractR,'Faxa_dstwet3' )
  index_c2l_Faxa_dstwet4  = cpl_interface_contractIndex(contractR,'Faxa_dstwet4' )
  index_c2l_Faxa_dstdry1  = cpl_interface_contractIndex(contractR,'Faxa_dstdry1' )
  index_c2l_Faxa_dstdry2  = cpl_interface_contractIndex(contractR,'Faxa_dstdry2' )
  index_c2l_Faxa_dstdry3  = cpl_interface_contractIndex(contractR,'Faxa_dstdry3' )
  index_c2l_Faxa_dstdry4  = cpl_interface_contractIndex(contractR,'Faxa_dstdry4' )

  index_r2c_Forr_ioff     = cpl_interface_contractIndex(contractSR,'Forr_ioff')
!------------------wangln 2012-06-26 for CAM5---------------------------
...
#ifdef CPLDUMP
    ! Initialize forcing data dump module
    call cpldump_init(lread=.false.)
#endif
...
!      rhoair    =  (pbot-0.378*qm*pbot/(0.622+0.378*qm))/(rgas*tm)
       ...
       forcg%pco2m(g)        = bufR(g,index_c2l_Sa_pbot)*co2_ppmv_val*1.e-6

       forcg%po2m(g)         = bufR(g,index_c2l_Sa_pbot)*po2
       forcg%us(g)           = bufR(g,index_c2l_Sa_u   )  !forc_uxy  Atm state m/s
       forcg%vs(g)           = bufR(g,index_c2l_Sa_v   )  !forc_vxy  Atm state m/s
       forcg%tm(g)           = bufR(g,index_c2l_Sa_tbot)  !forc_txy  Atm state K
       forcg%qm(g)           = bufR(g,index_c2l_Sa_shum)  !forc_qxy  Atm state kg/kg
       ...
       forcg%prc(g)          = forc_rainc + forc_snowc
       forcg%prl(g)          = forc_rainl + forc_snowl
       forcg%rain(g)         = forc_rainc + forc_rainl
       forcg%snow(g)         = forc_snowc + forc_snowl

       forcg%pbot(g)         = bufR(g,index_c2l_Sa_pbot)  !ptcmxy  Atm state Pa
       forcg%psrf(g)         = bufR(g,index_c2l_Sa_pbot)  !ptcmxy  Atm state Pa

       forcg%sols(g)         = bufR(g,index_c2l_Faxa_swvdr)  !forc_solsxy  Atm flux  W/m^2
       forcg%soll(g)         = bufR(g,index_c2l_Faxa_swndr)  !forc_sollxy  Atm flux  W/m^2
       forcg%solsd(g)        = bufR(g,index_c2l_Faxa_swvdf)  !forc_solsdxy Atm flux  W/m^2
       forcg%solld(g)        = bufR(g,index_c2l_Faxa_swndf)  !forc_solldxy Atm flux  W/m^2

       forcg%frl(g)          = bufR(g,index_c2l_Faxa_lwdn)  !flwdsxy Atm flux  W/m^2
       forcg%hu(g)           = bufR(g,index_c2l_Sa_z     )  !zgcmxy  Atm state m
       forcg%ht(g)           = bufR(g,index_c2l_Sa_z     )  !zgcmxy  Atm state m
       forcg%hq(g)           = bufR(g,index_c2l_Sa_z     )  !zgcmxy  Atm state m
!------------------wangln 2012-06-26 for CAM5---------------------------
!       forcg(19,g)           = bufR(g,index_c2l_Faxa_bcphidry     )  !zgcmxy  Atm state m
!       forcg(20,g)           = bufR(g,index_c2l_Faxa_bcphodry     )  !zgcmxy  Atm state m
!       forcg(21,g)           = bufR(g,index_c2l_Faxa_bcphiwet     )  !zgcmxy  Atm state m
!       forcg(22,g)           = bufR(g,index_c2l_Faxa_ocphidry     )  !zgcmxy  Atm state m
!       forcg(23,g)           = bufR(g,index_c2l_Faxa_ocphodry     )  !zgcmxy  Atm state m
!       forcg(24,g)           = bufR(g,index_c2l_Faxa_ocphiwet     )  !zgcmxy  Atm state m
!       forcg(25,g)           = bufR(g,index_c2l_Faxa_dstdry1     )  !zgcmxy  Atm state m
!       forcg(26,g)           = bufR(g,index_c2l_Faxa_dstdry2     )  !zgcmxy  Atm state m
!       forcg(27,g)           = bufR(g,index_c2l_Faxa_dstdry3     )  !zgcmxy  Atm state m
!       forcg(28,g)           = bufR(g,index_c2l_Faxa_dstdry4     )  !zgcmxy  Atm state m
!       forcg(29,g)           = bufR(g,index_c2l_Faxa_dstwet1     )  !zgcmxy  Atm state m
!       forcg(30,g)           = bufR(g,index_c2l_Faxa_dstwet2     )  !zgcmxy  Atm state m
!       forcg(31,g)           = bufR(g,index_c2l_Faxa_dstwet3     )  !zgcmxy  Atm state m
!       forcg(32,g)           = bufR(g,index_c2l_Faxa_dstwet4     )  !zgcmxy  Atm state m
!------------------wangln 2012-06-26 for CAM5---------------------------

#ifdef MYBUG
       if(isnan(forcg%tm(g)) .and. p_master) write(6,*) 'forcg', gxmap(g), gymap(g)!, forcg(:,g)
#endif
...
!------------------wangln 2012-06-26 for CAM5---------------------------
          bufS(g,index_l2c_Sl_fv)     = 0.
          bufS(g,index_l2c_Sl_ram1)   = 0.
          bufS(g,index_l2c_Fall_flxdst1) = 0.
          bufS(g,index_l2c_Fall_flxdst2) = 0.
          bufS(g,index_l2c_Fall_flxdst3) = 0.
          bufS(g,index_l2c_Fall_flxdst4) = 0.
          if ( index_l2c_Fall_flxvoc1 /=0 ) bufS(g,index_l2c_Fall_flxvoc1) = 0.
          if ( index_l2c_Fall_flxvoc2 /=0 ) bufS(g,index_l2c_Fall_flxvoc2) = 0.
          if ( index_l2c_Fall_flxvoc3 /=0 ) bufS(g,index_l2c_Fall_flxvoc3) = 0.
          if ( index_l2c_Fall_flxvoc4 /=0 ) bufS(g,index_l2c_Fall_flxvoc4) = 0.
          if ( index_l2c_Fall_flxvoc5 /=0 ) bufS(g,index_l2c_Fall_flxvoc5) = 0.
!------------------wangln 2012-06-26 for CAM5---------------------------
...
#ifdef CPLDUMP
    call cpldump_send(lnd_trad,lnd_scv,lnd_avsdr,lnd_avsdf,lnd_anidr,lnd_anidf, &
                      lnd_tref,lnd_qref,lnd_u10m,lnd_v10m,lnd_sublim,lnd_taux,  &
                      lnd_tauy,lnd_lhflx,lnd_shflx,lnd_lwup,lnd_qflx,lnd_swabs,lnd_nee)
#endif
