...
! Get my processor names
   ...
   !*call mpi_allgather (p_counts(p_iam),1,mpi_integer,p_counts,1,mpi_integer,p_comm,p_err) ! jidy@21-Mar-2014
     call mpi_allgather (MPI_IN_PLACE   ,1,mpi_integer,p_counts,1,mpi_integer,p_comm,p_err) ! jidy@21-Mar-2014
     ...
     if (p_master) then
        call mpi_gatherv (MPI_IN_PLACE  ,p_counts(p_iam),mpi_character, &
