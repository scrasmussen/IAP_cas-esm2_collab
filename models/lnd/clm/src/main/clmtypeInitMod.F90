...
!------------------------------------------------------------------------
    ...
    allocate(pdf%Cd(beg:end))
!!! added by fkc
    allocate(pdf%lnd_frc_mbl(beg:end))
    allocate(pdf%frc_thr_wet_fct(beg:end))
    allocate(pdf%mss_frc_cly_vld1(beg:end))
!!! 
    ...
    pdf%Cd(beg:end) = nan
!!! added by fkc
    pdf%lnd_frc_mbl(beg:end) = nan
    pdf%frc_thr_wet_fct(beg:end) = nan
    pdf%mss_frc_cly_vld1(beg:end) = nan
!!!
