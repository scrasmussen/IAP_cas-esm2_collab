...
!zmh           write(*,*)'scm_iop_srf_prop',scm_iop_srf_prop, have_lhflx
...
!    write(*,*)'iop_surf----- begchunk,endchunk',begchunk,endchunk
!    write(*,*) 'lhflxobs,shflxobs',lhflxobs,shflxobs
!    write(*,*) 'cam_in(c)%lhf(1)',cam_in(c)%lhf(1)
