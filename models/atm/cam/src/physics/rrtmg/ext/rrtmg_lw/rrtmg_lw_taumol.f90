...
!----------------------------------------------------------------------------
      subroutine taumol(nlayers, pavel, wx, coldry, &
                        ...
                        zmh_colh2o, colco2, colo3, coln2o, colco, colch4, colo2, &  !zmh
...
! ----- Input -----
      ...
      real(kind=r8), intent(in) :: zmh_colh2o(:)          ! column amount (h2o)  !zmh
                                                      !    Dimensions: (nlayers)
...
!zmh local                                                      !    Dimensions: (nlayers,ngptlw)
      real(kind=r8)     :: colh2o(nlayers)
      integer k
...
!zmh 2019-02-01
      do k = 1, nlayers
       colh2o(k) = zmh_colh2o(k)
       if(zmh_colh2o(k) .lt. 1.0e-20)then 
           colh2o(k) = 1.0e-20
       endif
      enddo 
...
! zmh
         if (specparm .lt. 1.e-20) specparm = 1.e-20
...
!zmh
         if (specparm_planck .lt. 1.e-20) specparm_planck=1.e-20
