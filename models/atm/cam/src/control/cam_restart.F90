...
!======================== zhh debug =======================
!      if (masterproc) print*, '-------------- at the beginning of sub. cam_write_restart --------------------'
!======================== zhh debug =======================
...
!======================== zhh debug =======================
!      if (masterproc) print*, '-------------- success timemgr_init_restart --------------------'
!======================== zhh debug =======================
      call init_restart_hycoef(File, vdimids)
!======================== zhh debug =======================
!      if (masterproc) print*, '-------------- success init_restart_hycoef --------------------'
!======================== zhh debug =======================
      call init_restart_dynamics(File, hdimids, vdimids, dyn_out)
!======================== zhh debug =======================
!      if (masterproc) print*, '-------------- success init_restart_dynamics --------------------'
!======================== zhh debug =======================
      call init_restart_physics(File, cam_out, hdimids)
      call init_restart_history(File)
!======================== zhh debug =======================
!      if (masterproc) print*, '-------------- success init_restart_history --------------------'
!======================== zhh debug =======================
      deallocate(hdimids)
...
!======================== zhh debug =======================
!      if (masterproc) print*, '-------------- success pio_closefile --------------------'
!======================== zhh debug =======================
      !-----------------------------------------------------------------------
