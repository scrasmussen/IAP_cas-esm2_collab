  ...
  character(len=*),parameter ::  specname_amode(ntot_aspectype) = (/ 'sulfate   ', 'ammonium  ', 'nitrate   ', &
...
#if ( defined MODAL_AERO_7MODE )
    real(r8), parameter :: dgnum_amode(ntot_amode)   = (/ 0.1100e-6, 0.0260e-6, 0.050e-6, 0.200e-6, 0.100e-6, 2.000e-6, 1.000e-6, 40.000e-6/)
    real(r8), parameter :: dgnumlo_amode(ntot_amode) = (/ 0.0535e-6, 0.0087e-6, 0.010e-6, 0.050e-6, 0.050e-6, 1.000e-6, 0.500e-6, 20.000e-6/)
    real(r8), parameter :: dgnumhi_amode(ntot_amode) = (/ 0.4400e-6, 0.0520e-6, 0.100e-6, 1.000e-6, 0.500e-6, 4.000e-6, 2.000e-6, 400.000e-6/)
#elif ( defined MODAL_AERO_4MODE )
    real(r8), parameter :: dgnum_amode(ntot_amode)   = (/ 0.1100e-6, 0.0260e-6, 2.000e-6, 20.000e-6/)
    real(r8), parameter :: dgnumlo_amode(ntot_amode) = (/ 0.0535e-6, 0.0087e-6, 1.000e-6, 10.00e-6 /)
    real(r8), parameter :: dgnumhi_amode(ntot_amode) = (/ 0.4400e-6, 0.0520e-6, 4.000e-6, 100.000e-6 /)
#elif ( defined MODAL_AERO_3MODE )
...
#if ( defined MODAL_AERO_7MODE )
    real(r8), parameter ::     sigmag_amode(ntot_amode)   = (/ 1.800, 1.600, 1.600, 2.000, 1.800, 2.000, 1.800, 2.000 /)
#elif ( defined MODAL_AERO_4MODE )
    real(r8), parameter ::     sigmag_amode(ntot_amode)   = (/ 1.800, 1.600, 1.800, 1.800 /)
#elif ( defined MODAL_AERO_3MODE )
...
#if ( defined MODAL_AERO_7MODE )
    real(r8), parameter ::     rhcrystal_amode(ntot_amode)  = (/ 0.350, 0.350, 0.350, 0.350, 0.350, 0.350, 0.350, 0.350 /)
    real(r8), parameter ::     rhdeliques_amode(ntot_amode) = (/ 0.800, 0.800, 0.800, 0.800, 0.800, 0.800, 0.800, 0.800 /)
#elif ( defined MODAL_AERO_4MODE )
    real(r8), parameter ::     rhcrystal_amode(ntot_amode)  = (/ 0.350, 0.350, 0.350, 0.350 /)
    real(r8), parameter ::     rhdeliques_amode(ntot_amode) = (/ 0.800, 0.800, 0.800, 0.800 /)
#elif ( defined MODAL_AERO_3MODE )
    ...
    integer :: msectional = -1
      ...
      integer                                       &   !
          ...
          modeptr_coardust,  modeptr_coarseas, modeptr_newseas
      ...
      contains
        ...
        function qqcw_get_field(index, lchnk, errorhandle)
          ...
          if(index>0 .and. index <= pcnst .and. qqcw(index)>0) then
             ...
             write(iulog,*)'index is ', index, 'pcnst is ', pcnst, 'qqcw is ', qqcw(index)
