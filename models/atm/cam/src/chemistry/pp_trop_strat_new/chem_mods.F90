...
!--------------------------------------------------------------
      ...
      implicit none
      save
      integer, parameter :: hetcnt = 55, & ! number of heterogeneous processes
                            phtcnt = 18, & ! number of photolysis reactions
                            rxntot = 99, & ! number of total reactions
                            gascnt = 81, & ! number of gas phase reactions
                            nabscol = 2, & ! number of absorbing column densities
                            gas_pcnst = 55, & ! number of "gas phase" species
                            nfs = 4, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 238, & ! number of non-zero matrix entries
