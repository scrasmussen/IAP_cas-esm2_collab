...
!u3,v3,qminus,need test!!!!!
      ...
      call mp_send3d(commyz,dest,src,plond,plev,platd,1,plond,beglev,endlev,beglatex,endlatex,&
                      1,plond,beglev,endlev,beglatex+3,beglatex+4,adv_state%u3)
      call mp_recv3d(commyz,src,plond,plev,platd,1,plond,beglev,endlev,beglatex,endlatex,&
                      1,plond,beglev,endlev,endlatex-2,endlatex-1,adv_state%u3)
!
      call mp_send3d(commyz,dest,src,plond,plev,platd,1,plond,beglev,endlev,beglatex,endlatex,&
                      1,plond,beglev,endlev,beglatex+3,beglatex+4,adv_state%v3)
      call mp_recv3d(commyz,src,plond,plev,platd,1,plond,beglev,endlev,beglatex,endlatex,&
                      1,plond,beglev,endlev,endlatex-2,endlatex-1,adv_state%v3)
!
      call mp_send3d( commyz, dest, src, plond,plev*pcnst , platd,&
                      1, plond,beglev,(endlev-beglev+1)*pcnst+beglev-1,beglatex, endlatex,       &
                      1,plond,beglev,(endlev-beglev+1)*pcnst+beglev-1,beglatex+3 , beglatex+4,adv_state%qminus )
      call mp_recv3d( commyz, src, plond,plev*pcnst,platd,&
                      1, plond,beglev,(endlev-beglev+1)*pcnst+beglev-1,beglatex, endlatex,       &
                      1, plond,beglev,(endlev-beglev+1)*pcnst+beglev-1,endlatex-2, endlatex-1,  adv_state%qminus)
      call mp_send3d(commyz,dest,src,plond,plev,platd,1,plond,beglev,endlev,beglatex,endlatex,&
                      1,plond,beglev,endlev,beglatex+5,beglatex+5,adv_state%u3)
      call mp_recv3d(commyz,src,plond,plev,platd,1,plond,beglev,endlev,beglatex,endlatex,&
                      1,plond,beglev,endlev,endlatex,endlatex,adv_state%u3)
!
      call mp_send3d(commyz,dest,src,plond,plev,platd,1,plond,beglev,endlev,beglatex,endlatex,&
                      1,plond,beglev,endlev,beglatex+5,beglatex+5,adv_state%v3)
      call mp_recv3d(commyz,src,plond,plev,platd,1,plond,beglev,endlev,beglatex,endlatex,&
                      1,plond,beglev,endlev,endlatex,endlatex,adv_state%v3)
!
      call mp_send3d( commyz, dest, src, plond,plev*pcnst , platd,&
                      1, plond,beglev,(endlev-beglev+1)*pcnst+beglev-1,beglatex, endlatex,       &
                      1,plond,beglev,(endlev-beglev+1)*pcnst+beglev-1,beglatex+5 , beglatex+5,adv_state%qminus )
      call mp_recv3d( commyz, src, plond,plev*pcnst,platd,&
                      1, plond,beglev,(endlev-beglev+1)*pcnst+beglev-1,beglatex, endlatex,       &
                      1, plond,beglev,(endlev-beglev+1)*pcnst+beglev-1,endlatex, endlatex,  adv_state%qminus)
...
!
      ...
      if ( mod(iam+1,npr_y) == 0 ) dest = -1
       if(comnum==2) then
      call mp_send3d(commyz,dest,src,plond,plev,platd,1,plond,beglev,endlev,beglatex,endlatex,&
                      1,plond,beglev,endlev,endlatex-4,endlatex-3,adv_state%u3)
      call mp_recv3d(commyz,src,plond,plev,platd,1,plond,beglev,endlev,beglatex,endlatex, &
                      1,plond,beglev,endlev,beglatex+1,beglatex+2,adv_state%u3)
!
      call mp_send3d(commyz,dest,src,plond,plev,platd,1,plond,beglev,endlev,beglatex,endlatex,&
                      1,plond,beglev,endlev,endlatex-4,endlatex-3,adv_state%v3)
      call mp_recv3d(commyz,src,plond,plev,platd,1,plond,beglev,endlev,beglatex,endlatex, &
                      1,plond,beglev,endlev,beglatex+1,beglatex+2,adv_state%v3)
!
      call mp_send3d( commyz, dest, src, plond,plev*pcnst , platd,&
                      1, plond,beglev,(endlev-beglev+1)*pcnst+beglev-1,beglatex, endlatex,       &
                      1,plond,beglev,(endlev-beglev+1)*pcnst+beglev-1,endlatex-4 , endlatex-3,adv_state%qminus )
      call mp_recv3d( commyz, src, plond,plev*pcnst,platd,&
                      1, plond,beglev,(endlev-beglev+1)*pcnst+beglev-1,beglatex, endlatex,       &
                      1, plond,beglev,(endlev-beglev+1)*pcnst+beglev-1,beglatex+1, beglatex+2,  adv_state%qminus)

      call mp_send3d(commyz,dest,src,plond,plev,platd,1,plond,beglev,endlev,beglatex,endlatex,&
                      1,plond,beglev,endlev,endlatex-5,endlatex-5,adv_state%u3)
      call mp_recv3d(commyz,src,plond,plev,platd,1,plond,beglev,endlev,beglatex,endlatex, &
                      1,plond,beglev,endlev,beglatex,beglatex,adv_state%u3)
!
      call mp_send3d(commyz,dest,src,plond,plev,platd,1,plond,beglev,endlev,beglatex,endlatex,&
                      1,plond,beglev,endlev,endlatex-5,endlatex-5,adv_state%v3)
      call mp_recv3d(commyz,src,plond,plev,platd,1,plond,beglev,endlev,beglatex,endlatex, &
                      1,plond,beglev,endlev,beglatex,beglatex,adv_state%v3)
!
      call mp_send3d( commyz, dest, src, plond,plev*pcnst , platd,&
                      1, plond,beglev,(endlev-beglev+1)*pcnst+beglev-1,beglatex, endlatex,       &
                      1,plond,beglev,(endlev-beglev+1)*pcnst+beglev-1,endlatex-5 , endlatex-5,adv_state%qminus )
      call mp_recv3d( commyz, src, plond,plev*pcnst,platd,&
                      1, plond,beglev,(endlev-beglev+1)*pcnst+beglev-1,beglatex, endlatex,       &
                      1, plond,beglev,(endlev-beglev+1)*pcnst+beglev-1,beglatex, beglatex,  adv_state%qminus)
...
! ====================================== zhh ==================================
   ...
   real(r8) :: WQ(NX,beglev:endlev+1,beglatdyn:endlatdyn)  
...
!
      do k = beglev,endlev     ! The bug was fixed by Zhang He on 2017-07-19
         do i = 1, plon
