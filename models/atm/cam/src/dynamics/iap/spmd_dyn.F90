...
!                                                  (excl. tracers)
   ...
   integer:: comnum  !jjr test comunication method control
...
!czy20180506
   ...
   DTIMEQ = Ndq*DTlin 
!zmh   
   zmh_cfl_u0r = 1.0 - min(0.9999_r8, max(0.20_r8,zmh_cfl_u0r))
...
!zmh
   ...
   call mpibcast (zmh_cfl_drag ,1,mpilog,0,mpicom)
   call mpibcast (zmh_cfl_u0r  ,1,mpiint,0,mpicom)
