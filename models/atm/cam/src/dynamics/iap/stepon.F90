...
!======================== 2012.01.16 =============================
!jjr   call mpi_barrier(mpicom,ierr)
  call t_startf ('dynpkg')
!jjr test   call take_valuet
