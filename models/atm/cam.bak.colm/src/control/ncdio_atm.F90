...
!---------------------------- test zhh ------------------------
!!             if (masterproc) print*, '========= At sub.infld_real_3d: before calling get_phys_decomp ========== '
!!             print*, '-------before calling get_phys_decomp--------'
!---------------------------- test zhh ------------------------
             call get_phys_decomp(iodesc, 1, dimlev, 1, pio_double, 'xzy')
!---------------------------- test zhh ------------------------
!!             print*, '------------ after calling get_phys_decomp: iam =', iam
!---------------------------- test zhh ------------------------
             call pio_read_darray(ncid, varid, iodesc, field, ierr)
!---------------------------- test zhh ------------------------
!!             if (masterproc) print*, '-------after calling pio_read_darray--------'
!---------------------------- test zhh ------------------------
          else
