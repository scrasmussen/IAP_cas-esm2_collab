...
!
      ...
      !-----------------------------------------------------------------
       ...
       !LiuJP's team
       ! visible (0.25-0.69 miu-m), IR1 (0.69-1.19 miu-m), &
       ! IR2 (1.19-2.38 miu-m), IR3 (2.38-4.00 miu-m)
      ...
      real (kind=dbl_kind), dimension (nx_block,ny_block,max_blocks) :: &
         ...
         !LiuJP's team
         fswsfc  , & ! shortwave surface absorbed heat flux (W/m^2)
...
!
      ...
      real (kind=dbl_kind), dimension(nx_block,ny_block), intent(in):: &
          ...
          !LiuJP's team
          fswsfcn , & ! sw surface absorbed heat flx   (W/m**2)
