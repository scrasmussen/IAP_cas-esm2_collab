...
!zhh debug
!   print*, '------------- before calling departure_points --------------'
...
!---------- zhh debug 2014-07-25 --------------
!         if (nx_block==32 .and. ny_block==12 .and. iblk==3 ) then
!            do jzh = 1, ny_block
!               do izh = 1, nx_block
!                  write(nu_diag,*) '==========================================================='
!                  write(nu_diag,*) 'i =',izh,' j =', jzh
!                  write(nu_diag,*) 'uvel =', uvel(izh,jzh,3), ' vvel =', vvel(izh,jzh,3)
!                  write(nu_diag,*) 'dxu =', dxu(izh,jzh,3), ' dyu =', dyu(izh,jzh,3)
!                 write(nu_diag,*) 'HTN =', HTN(izh,jzh,3), ' HTE =', HTE(izh,jzh,3)
!                  write(nu_diag,*) 'dpx =', dpx(izh,jzh,3), ' dpy =', dpy(izh,jzh,3)
!               end do
!            end do
!         end if
!---------- zhh debug 2014-07-25 --------------
...
!-----zhh debug 2014-07-23 -------
! zmh
#define SCAM_SKIP
#if ( ! defined SCAM_SKIP) 
...
!------- zhh debug 2014-07-24 --------
         write (nu_diag,*) 'uvel(i,j), uvel(i+1,j) =', uvel(i,j), uvel(i+1,j)
         write (nu_diag,*) 'vvel(i,j), vvel(i,j+1) =', vvel(i,j), vvel(i,j+1)
!------- zhh debug 2014-07-24 --------
