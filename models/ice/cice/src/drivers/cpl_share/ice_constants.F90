...
!        rho_air   = SHR_CONST_RHODAIR,&! ambient air density (kg/m^3)
      ...
      real (kind=dbl_kind), parameter :: &
         ...
         !LiuJP's team
         kappavni  = 1.4_dbl_kind ,& ! vis extnctn coef in ice, wvlngth<700nm (1/m)
         kappai1ni = 17.6_dbl_kind,& ! near IR1 extnctn coef in ice, wvlngth>700nm (1/m)
         kappai2ni = 17.6_dbl_kind,& ! near IR2 extnctn coef in ice, wvlngth>700nm (1/m)
         kappai3ni = 17.6_dbl_kind,& ! near IR3 extnctn coef in ice, wvlngth>700nm (1/m)

         kappavdns  = 19.6_dbl_kind,& ! vis extnctn coef in dry snow, wvlngth<700nm (1/m)
         kappai1dns = 196_dbl_kind, & ! near IR1 extnctn coef in dry snow, wvlngth>700nm (1/m)
         kappai2dns = 196_dbl_kind, & ! near IR2 extnctn coef in dry snow, wvlngth>700nm (1/m)
         kappai3dns = 196_dbl_kind, & ! near IR3 extnctn coef in dry snow, wvlngth>700nm (1/m)

         kappavwns  = 10.7_dbl_kind,& ! vis extnctn coef in wet snow, wvlngth<700nm (1/m)
         kappai1wns = 118_dbl_kind, & ! near IR1 extnctn coef in wet snow, wvlngth>700nm (1/m)
         kappai2wns = 118_dbl_kind, & ! near IR2 extnctn coef in wet snow, wvlngth>700nm (1/m)
         kappai3wns = 118_dbl_kind, & ! near IR3 extnctn coef in wet snow, wvlngth>700nm (1/m)
...
! .636/.364 vis/nir with only 0.5% direct for each band.
      ...
      real (kind=dbl_kind), parameter :: &
        ...
        pi2    = c2*pi, &
        !LiuJP's team
        p0082  = 0.0082_dbl_kind, &
        p007   = 0.0070_dbl_kind, &
        p026   = 0.026_dbl_kind, &
        p065   = 0.065_dbl_kind, &
        p015   = 0.015_dbl_kind
      ...
      real (kind=dbl_kind), parameter :: &
        ...
        !LiuJP's team
        g_to_ton      = 1.e-6_dbl_kind    ! g to ton  
