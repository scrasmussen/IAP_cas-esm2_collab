  ...
  use ice_flux,        only : strairxt, strairyt, strocnxt, strocnyt,    &
			      alvdr, alidr, alvdf, alidf, Tref, Qref, Uref, &
		              ...
		              sss, tf, wind, fsw, init_flux_atm, init_flux_ocn,&
                              faero, &
                              !LiuJP's team
                              cldf, swi1dr, swi1df, swi2dr, swi2df, swi3dr, swi3df
...
!----------- zhh debug 2014-05-27 ------------
    print*, 'At sub. ice_domain_mct, before calling mct_gGrid_importRAttr'
!----------- zhh debug 2014-05-27 ------------
...
!----------- zhh debug 2014-05-27 ------------
    print*, 'At sub. ice_domain_mct, after calling mct_gGrid_importRAttr'
!----------- zhh debug 2014-05-27 ------------
    !
