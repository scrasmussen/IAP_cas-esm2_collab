...
!
      ...
      subroutine dumpfile(cldf,filename_spec)
!
! !DESCRIPTION:
!
...
!
      ...
      !LiuJP's team
      call define_rest_field(ncid,'cldf',dims)
      call define_rest_field(ncid,'swi1dr',dims)
      call define_rest_field(ncid,'swi1df',dims)
      call define_rest_field(ncid,'swi2dr',dims)
      call define_rest_field(ncid,'swi2df',dims)
      call define_rest_field(ncid,'swi3dr',dims)
      call define_rest_field(ncid,'swi3df',dims)
      ...
      !LiuJP's team
      call ice_write_nc(ncid,1,'cldf',cldf,'rda8',diag)
      call ice_write_nc(ncid,1,'swi1dr',swidr,'rda8',diag)
      call ice_write_nc(ncid,1,'swi1df',swidf,'rda8',diag)
      call ice_write_nc(ncid,1,'swi2dr',swidr,'rda8',diag)
      call ice_write_nc(ncid,1,'swi2df',swidf,'rda8',diag)
      call ice_write_nc(ncid,1,'swi3dr',swidr,'rda8',diag)
      call ice_write_nc(ncid,1,'swi3df',swidf,'rda8',diag)
...
!
      ...
      subroutine restartfile(cldf,ice_ic)
!
! !DESCRIPTION:
!
...
!
      ...
      call ice_read_nc(ncid,1,'swidf',swidf,diag, &
                    field_loc_center, field_type_scalar)
      !LiuJP's team
      call ice_read_nc(ncid,1,'cldf',cldf,diag, &
                    field_loc_center, field_type_scalar)
      call ice_read_nc(ncid,1,'swi1dr',swi1dr,diag, &
                    field_loc_center, field_type_scalar)
      call ice_read_nc(ncid,1,'swi1df',swi1df,diag, &
                    field_loc_center, field_type_scalar)
      call ice_read_nc(ncid,1,'swi2dr',swi2dr,diag, &
                    field_loc_center, field_type_scalar)
      call ice_read_nc(ncid,1,'swi2df',swi2df,diag, &
                    field_loc_center, field_type_scalar)
      call ice_read_nc(ncid,1,'swi3dr',swi3dr,diag, &
                    field_loc_center, field_type_scalar)
      call ice_read_nc(ncid,1,'swi3df',swi3df,diag, &
                    field_loc_center, field_type_scalar)
